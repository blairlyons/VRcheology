        ...
        public class HMDSimulator : MonoBehaviour {
                    ...
                    if (isCameraInitializationComplete) {
                        if (isUsingSteamRig) {
                            try {
                                ...
                                throw new System.NullReferenceException("Camera (head) object not found. This happens in Unity 5.4 when SteamVR is on and the Vive is plugged in, or if you have changed the name of the Camera (head) game object.");
                            }
                        } else {
                            try {
                                return CameraRig;
            ...
            void setOculusCameraRigInitialPosition() {
                ...
                if (CameraRig.parent == null) {
                    ...
                    rootTransform.position = new Vector3(CameraRig.position.x, 1.06f, CameraRig.position.y);
